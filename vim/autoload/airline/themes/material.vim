...
let s:CP1 = [ s:guiWhite , s:gui01 , s:ctermWhite , s:ctermBlack  ]
let s:CP2 = [ s:guiWhite , s:gui03 , s:ctermWhite , s:ctermBlack  ]
let s:CP3 = [ s:guiWhite , s:gui0D , s:ctermWhite , s:ctermGray ]
